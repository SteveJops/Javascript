...
module.exports = {
  ...
  mode: "development",
  // mode: 'production' либо так забилдить проэкт

  /* "build": "webpack --mode=production" либо еще так можно в package.json + npm run build */

  /** Чтобы каждый раз после сборки(билда) проэкта некоторые новые файлы не перезаписывались,
   *  а некоторые не создавались новые и не получалась каша, нужно установить клинер
